...
SELECT count() FROM (SELECT number < 100 AS n FROM numbers(20000) ORDER BY n DESC LIMIT 0.005 WITH TIES);
SELECT '*';
SELECT count() FROM (SELECT number < 100 AS n FROM numbers(20000) ORDER BY n DESC LIMIT 0.003 WITH TIES);
SELECT '*';
SELECT count() FROM (SELECT number < 200 AS n FROM numbers(20000) ORDER BY n DESC LIMIT 0.01 WITH TIES);
SELECT '*';
SELECT count() FROM (SELECT number < 200 AS n FROM numbers(20000) ORDER BY n DESC LIMIT 0.006 WITH TIES);
SELECT '';

SET max_block_size = 33;
SELECT count() FROM (SELECT number < 100 AS n FROM numbers(20000) ORDER BY n DESC LIMIT 0.005 WITH TIES);
SELECT '*';
SELECT count() FROM (SELECT number < 100 AS n FROM numbers(20000) ORDER BY n DESC LIMIT 0.003 WITH TIES);
SELECT '*';
